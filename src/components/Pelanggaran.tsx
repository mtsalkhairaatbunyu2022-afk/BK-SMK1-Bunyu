      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white p-6 rounded-xl shadow-sm border border-slate-200 h-fit">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Metode Penanganan</label>
              <select
              ...
              >
                ...
                <option value="Ruang BK / Intervensi Khusus">Ruang BK / Intervensi Khusus</option>
                ...
                <option value="Teguran Lisan / Tulisan">Teguran Lisan / Tulisan</option>
                <option value="Lainnya">Lainnya...</option>
              </select>
              {handlingMethod === "Lainnya" && (
                <input
                  type="text"
                  placeholder="Ketik metode penanganan lainnya..."
                  onChange={(e) => setHandlingMethod(e.target.value)}
                ...
                <div key={record.id} className="p-4 rounded-xl border border-slate-200 bg-slate-50 hover:border-blue-300 transition-colors group text-left">
                  ...
                  {record.handlingMethod && (
                    <div className="mt-3 pt-3 border-t border-slate-200">
                      <span className="text-xs font-bold text-slate-500 uppercase">PENANGANAN:</span>
